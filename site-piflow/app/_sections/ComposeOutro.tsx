                ...
                >
                  ...
                  <p className="intro-copy intro-reveal text-balance text-3xl text-fg sm:text-4xl">
                    ...
                    <span>
                      ...
                      <span className="io-glass">AI in education</span> — making learning tools that feel more useful, personal, and accessible.
                    </span>{" "}
