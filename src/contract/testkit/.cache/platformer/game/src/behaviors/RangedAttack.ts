...
export const CAPABILITY = {
  kind: 'behavior',
  id: 'RangedAttack',
  intent: 'Spawn projectiles into playerBullets/enemyBullets with cooldown; collision resolved by BaseLevelScene.',
  roles: ['player', 'enemy'],
  params: ['damage', 'projectileKey', 'projectileSpeed', 'projectileSize', 'hasGravity', 'cooldown', 'spawnOffset'],
  tuning: ['attackDamage'],
} as const;
