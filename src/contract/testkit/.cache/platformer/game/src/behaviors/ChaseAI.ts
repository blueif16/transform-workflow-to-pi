...
export const CAPABILITY = {
  kind: 'behavior',
  id: 'ChaseAI',
  intent: 'Chase a target with detection range, stop distance, give-up distance; optional vertical chase for fliers.',
  roles: ['enemy'],
  params: ['speed', 'detectionRange', 'stopDistance', 'giveUpDistance', 'chaseVertical', 'verticalSpeedMultiplier'],
  tuning: ['walkSpeed'],
} as const;
