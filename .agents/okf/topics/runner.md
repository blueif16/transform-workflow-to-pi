...
- `runNode` (packages/core/src/runner/node-lifecycle.ts:80) — 3 callers in `packages/core/src/runner/retry.ts`, `packages/core/src/runner/runner.ts`; ⚠ no covering tests found
...
- `RunScope` (packages/core/src/types.ts:597) — 17 callers in `packages/core/src/runner/node-lifecycle.ts`, `packages/core/src/runner/resume.ts`, `packages/core/src/runner/retry.ts`, `packages/core/src/runner/runner.ts` +5 more; ⚠ no covering tests found

<sub>derived 2026-06-30 · arc=100 commits · files=7 · lessons=5</sub>
<!-- okf:auto-end -->
